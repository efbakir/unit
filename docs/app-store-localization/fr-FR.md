...
22 chars. "Carnet de muscu" is what French lifters call their training notebook; "muscu" is the colloquial anchor term for the whole category.

## Subtitle (30 max)

```
Journal de musculation rapide
```

29 chars. Keyword-dense: "journal", "musculation", "rapide" all searchable.

## Promotional text (170 max)

```
Nouveau en v2 : collez votre programme et démarrez dès le premier jour avec vos charges réelles. Pas de compte, pas de pub — tout reste sur votre iPhone.
```
...
```
entraînement,force,fitness,salle,haltères,squat,répétitions,séries,poids,programme
```

82 chars. Intent notes:
- "salle" — "la salle" is how French lifters say the gym; short and high volume.
- "entraînement" — the training category term; "musculation" already sits in the subtitle.
...
- "Muscu" in the app name is informal; if App Review or the native reader objects, fallback name: `Unit — Carnet d'entraînement` (28 chars).
