...
| `docs/app-store-submission/final-submit-checklist.md` | v2.1 (build 58) ASC handoff — clean-main provenance gate + screenshot capture runbook | Submitting v2.1 to App Review |
